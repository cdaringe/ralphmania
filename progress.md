...
| ---------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| ARCH.1     | VERIFIED | [Hexagonal boundary enforced: contracts in ports/types, Deno adapters in ports/impl, with integration+e2e coverage](docs/scenarios/ARCH.1-hexagonal-architecture.md) |              |
...
| 31         | VERIFIED | [Conflict-aware parallel dispatch via area clustering](docs/scenarios/31-conflict-aware-dispatch.md)                                                                 |              |
...
| GUI.b      | VERIFIED | [Live GUI status diff with e2e tests via DI adapters](docs/scenarios/GUI.b-status-diff.md)                                                                           |              |
